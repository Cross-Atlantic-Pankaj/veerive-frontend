      ...
      <div className="w-full">
        <div className="w-full bg-[#5F32D6] min-h-[500px] flex items-center">
          <div className="w-full max-w-[1200px] mx-auto px-2 sm:px-4 lg:px-6">
            <div className="flex flex-col max-[530px]:flex-col min-[531px]:flex-row items-center min-[531px]:items-start py-4 sm:py-6 md:py-8 max-[530px]:py-4 min-[531px]:py-12">
              <div className="w-full min-[531px]:w-2/5 min-[531px]:pr-2 sm:pr-4 text-center min-[531px]:text-left">
                <h1 className="text-white block text-[18px] sm:text-[24px] md:text-[32px] lg:text-[40px] xl:text-[50px] font-bold leading-tight">
                  Democratizing fintech intelligence
                </h1>
                <p className="mt-2 max-[530px]:mt-1 text-white/90 text-xs max-[530px]:text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl leading-relaxed max-w-[350px] max-[530px]:max-w-[300px] mx-auto min-[531px]:mx-0">
                  One platform. Every fintech insight that matters.
                </p>
                <div className="mt-3 max-[530px]:mt-2 flex justify-center min-[531px]:justify-start">
                  <div className="flex w-full max-w-[300px] max-[530px]:max-w-[250px]">
                    <input
                      type="email"
                      placeholder="Enter your email address"
                      aria-label="Email address"
                      className="flex-1 px-2 max-[530px]:px-1.5 py-1.5 max-[530px]:py-1 rounded-l-full bg-white text-gray-900 placeholder-gray-500 focus:outline-none text-xs max-[530px]:text-xs sm:text-sm"
                    />
                    <button className="px-3 max-[530px]:px-2 py-1.5 max-[530px]:py-1 bg-black text-white rounded-r-full font-medium text-xs max-[530px]:text-xs sm:text-sm whitespace-nowrap hover:bg-gray-800 transition-colors">
                      Join for free!
                    </button>
                  </div>
                </div>
              </div>
              <div className="w-full min-[531px]:w-3/5 mt-4 max-[530px]:mt-3 min-[531px]:mt-0 flex justify-end">
                <div className="relative w-full max-w-[400px] max-[530px]:max-w-[300px]">
                  {slides.length > 0 ? (
                    <div className="flex flex-col">
                      <div className="h-fit">
                        {slides.map((slide, index) => (
                          ...
                          >
                            <div className="bg-white rounded-lg p-4 sm:p-6 flex flex-col justify-between">
                              <div>
                                <p className="text-[#A084E8] text-xs sm:text-sm uppercase font-semibold mb-1 sm:mb-2">
                                  Featured {slide.title.split('Featured ')[1]}
                                </p>
                                <h2 className="text-[#5F32D6] text-sm sm:text-lg md:text-xl lg:text-2xl font-bold leading-tight">
                                  {slide.themeTitle ||
                                    slide.contextTitle ||
                                    slide.postTitle ||
                                    'N/A'}
                                ...
                                <p
                                  className="text-black text-sm sm:text-base mt-2 sm:mt-3 line-clamp-4"
                              ...
                              <div className="flex justify-end mt-2 sm:mt-4">
                                <Link href={slide.redirectUrl}>
                                  <button className="bg-[#7A5AF8] text-white px-4 sm:px-6 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium hover:bg-[#E550A3] transition-colors">
                                    Read More
                                  </button>
                                </Link>
                              </div>
                      ...
                      <div className="flex space-x-2 mt-2 sm:mt-4 pl-4 sm:pl-6 z-10">
                        {slides.map((_, index) => (
                          <button
                            key={index}
                            onClick={() => handleSlideChange(index)}
                            className={`w-6 sm:w-8 h-1 rounded-full transition-opacity duration-300 ${
                              currentSlide === index
                    ...
                    <div className="bg-gray-200 rounded-lg h-[200px] sm:h-[300px] flex items-center justify-center text-gray-500">
                      No slides available
                    </div>
                  )}
                </div>
              ...
              <>
                      ...
                      return (
                        ...
                        >
                          <Link href={`/context-details/${slug}`}>
                            <div className="bg-gray-100 aspect-[1000/630] relative mb-2 w-full">
                              {tileTemplate ? (
                                <Tile
                                  bg={tileTemplate.bg}
                            ...
                            {context.subSectors?.filter(
                              ...
                              <div className="flex flex-wrap gap-x-1 sm:gap-x-2 gap-y-1 sm:gap-y-2 mb-2 sm:mb-3">
                                {context.subSectors
                                  ...
                                  .map((subSector, index) => (
                                    ...
                                    >
                                      ...
                                      <div className="relative">
                                        <span className="text-xs sm:text-sm md:text-[15px] text-gray-600">
                                          {subSector.subSectorName}
                                        </span>
                                        <div className="absolute bottom-[-2px] sm:bottom-[-4px] left-0 w-full h-[1px] sm:h-[2px] bg-green-600"></div>
                                      </div>
                                    </div>
                                  ))}
                              </div>
                            ...
                            <h3 className="text-sm md:text-base lg:text-[17px] font-medium text-gray-900 leading-tight">
                ...
                {totalPages > 1 && (
                  <div className="flex justify-center mt-4 sm:mt-6 space-x-2 sm:space-x-4">
                    <button
                      onClick={prevPage}
                      className="w-8 sm:w-10 h-8 sm:h-10 flex items-center justify-center rounded-full bg-indigo-600 text-white hover:bg-indigo-700"
        ...
        <div className="w-full bg-white py-4 sm:py-6 md:py-8">
          <div className="max-w-[1400px] mx-auto px-2 sm:px-4 md:px-8">
            <div className="relative pb-2 sm:pb-4 mb-4 sm:mb-6">
              <div className="flex justify-between items-center">
                ...
                <Link
                  ...
                  className="text-[#6366F1] text-xs sm:text-sm"
                >
                  VIEW ALL →
                </Link>
              </div>
            ...
            <div className="flex flex-col lg:flex-row gap-2 sm:gap-4">
              <div className="lg:w-[40%]">
                {trendingThemes?.[0] && (
                  <Link
                    ...
                    className="block"
                  >
                    <div className="bg-gray-100 h-[200px] sm:h-[320px] relative w-full">
                    ...
                    <div className="mt-2 sm:mt-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-3 line-clamp-3">
                        {trendingThemes[0].themeDescription?.replace(
                          /<[^>]*>/g,
                          ''
                        )}
                      </p>
                      <button className="text-white bg-[#6366F1] px-2 sm:px-4 py-1 sm:py-2 rounded text-xs sm:text-sm hidden md:block hover:bg-[#5457E5] transition-colors">
                        Continue reading
                      </button>
                    </div>
                  </Link>
              ...
              <div className="lg:w-[60%] grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-4">
                {trendingThemes?.slice(1, 5).map((theme) => (
                  <Link
                    ...
                    className="block"
                  >
                    <div className="bg-gray-100 h-[100px] sm:h-[150px] relative w-full">
        ...
        <div className="w-full bg-[#6366F1] py-6 sm:py-8 md:py-10">
          <div className="max-w-[990px] mx-auto px-2 sm:px-4">
            <div className="text-center">
              <div className="text-white/90 text-sm sm:text-base font-medium mb-1 sm:mb-2">
                Get Started
              </div>
              ...
              <div className="relative max-w-[500px] sm:max-w-[600px] mx-auto">
                <input
                  type="email"
                  placeholder="Your Email address"
                  className="w-full px-3 sm:px-5 h-10 sm:h-12 md:h-14 rounded-full text-sm sm:text-base border-2 border-white/20 bg-white/10 text-white placeholder:text-white/50 focus:outline-none focus:border-white/40 focus:bg-white/20 transition-all pr-[100px] sm:pr-[140px]"
                />
                <button
                  onClick={handleSubscribe}
                  className="absolute right-1 top-1 bg-black text-white px-4 sm:px-6 py-2 sm:py-2 md:py-2.5 rounded-full text-sm font-medium hover:bg-gray-900 transition-colors"
                >
                  Subscribe
                </button>
              </div>
              <div className="text-white/80 text-xs sm:text-sm mt-2 sm:mt-3">
