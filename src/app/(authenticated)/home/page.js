                    ...
                    <div key={context._id} className="flex flex-col">
                      <Link href={`/context/${context._id}`}>
                        ...
                        <div className="flex flex-wrap gap-y-2 mb-3">
                          {context.sectors?.filter(sector => sector.sectorName).map((sector, index, filteredSectors) => (
                          ...
                          {context.subSectors?.filter(subSector => subSector.subSectorName).map((subSector, index, filteredSubSectors) => (
                            <div key={subSector._id} className="relative group inline-flex items-center">
                              {index === 0 && context.sectors?.some(sector => sector.sectorName) && (
                                <span className="mx-2 text-gray-400">|</span>
                              )}
                              <div className="relative">
                                <span className="text-sm md:text-[15px] text-gray-600">
                              ...
                              {index < filteredSubSectors.length - 1 && (
                                <span className="mx-2 text-gray-400">|</span>
                              )}
                            </div>
                          ))}
      ...
      <div className="w-full bg-white py-8">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1200px] mx-auto">
            <Link 
              href="/analyzer/sector-analyzer"
              className="block"
            >
              <div className="bg-gray-100 h-[280px] relative w-full">
          ...
          <div className="text-center">
            ...
            <div className="relative max-w-[600px] mx-auto">
              <input
                ...
                className="w-full px-5 h-14 rounded-full text-base
              ...
              <button className="absolute right-1 top-1 
                bg-black text-white 
                px-8 h-12 rounded-full text-base
                hover:bg-gray-900 
                transition-colors
                font-medium">
                Subscribe
